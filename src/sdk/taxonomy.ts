import type { ComponentManifestGroup } from "../manifest";
...
export const groupToCategory = {
  ...
  vmap1: "media",
  viz: "chart",
} satisfies Record<ComponentGroupId, ComponentCategory>;

/** Per-component category overrides. Empty by default; add only with a documented rationale. */
export const categoryOverrides: Partial<Record<string, ComponentCategory>> = {};
