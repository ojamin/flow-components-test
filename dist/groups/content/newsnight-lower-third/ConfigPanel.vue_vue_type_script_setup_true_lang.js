import { NewsnightLowerThirdConfigDefaults as e, NewsnightLowerThirdParams as t } from "./types.js";
...
//#region src/groups/content/newsnight-lower-third/ConfigPanel.vue?vue&type=script&setup=true&lang.ts
var c = /* @__PURE__ */ a({
	__name: "ConfigPanel",
	...
	setup(a, { emit: c }) {
		let l = c;
		return (a, c) => (o(), i(s(r), {
			title: "Newsnight Lower Third settings",
			params: s(t),
			defaults: s(e),
