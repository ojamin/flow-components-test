...
export type ParamControl = {
    ...
    placeholder?: string;
    testId?: string;
} | RecordFieldParamControl | FieldListParamControl | AggregateListParamControl | {
    kind: "textarea";
    rows?: number;
    placeholder?: string;
    testId?: string;
    ...
    testId?: string;
} | HeadersParamControl | ViewListParamControl | ViewSelectParamControl | ChartAdapterParamControl | ThemeRoleParamControl;
/**
...
export declare function param<TSchema extends ZodTypeAny>(schema: TSchema, meta: ParamMeta): ParamDescriptor<TSchema>;
/** Build a configSchema from a params record. Each descriptor's schema becomes the field schema. */
export declare function paramsToConfigSchema<TParams extends ComponentParams>(params: TParams): z.ZodObject<ComponentParamsShape<TParams>>;
export {};
